...
$(call Device/adtran_smartrg)
  ...
  DEVICE_PACKAGES +=  kmod-phy-aquantia kmod-usb3  automount
endef
...
$(call Device/adtran_smartrg)
  ...
  DEVICE_PACKAGES +=  kmod-phy-aquantia kmod-sfp kmod-usb3  automount
endef
...
define Device/arcadyan_mozart
  ...
  DEVICE_PACKAGES := kmod-hwmon-pwmfan e2fsprogs f2fsck mkf2fs 
...
define Device/bananapi_bpi-r4-common
  ...
  DEVICE_PACKAGES := kmod-hwmon-pwmfan kmod-i2c-mux-pca954x kmod-eeprom-at24 \
		     kmod-rtc-pcf8563 kmod-sfp kmod-phy-aquantia kmod-usb3 e2fsprogs f2fsck mkf2fs automount
